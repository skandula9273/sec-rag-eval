...
def _rrf_fuse(
    ...
    """Fuse two ranked lists by Reciprocal Rank Fusion, return top_k by RRF score.
    ...
    for rank, ch in enumerate(dense, start=1):
        scores[ch.chunk_id] = scores.get(ch.chunk_id, 0.0) + 1.0 / (k_rrf + rank)
